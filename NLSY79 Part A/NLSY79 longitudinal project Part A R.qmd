...
project_data <- read.csv("/Users/cristianthirteen/Downloads/Notre Dame/SP 24 Intro Machine Learning SP 24/Machine Learning Data Sets/Project1Data.csv")

project_headers <- read.csv("/Users/cristianthirteen/Downloads/Notre Dame/SP 24 Intro Machine Learning SP 24/Machine Learning Data Sets/Project1DataHeaders.csv", header = FALSE)
```
